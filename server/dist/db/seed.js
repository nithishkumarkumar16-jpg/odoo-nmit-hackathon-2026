...
const loginId_1 = require("../server/src/utils/loginId");
async function runSeed() {
    console.log('--- Starting Seed Script ---');
    // 1. Run migrations
    const schemaSql = fs_1.default.readFileSync(path_1.default.join(__dirname, '01_schema.sql'), 'utf-8');
    await (0, db_1.exec)(schemaSql);
    const funcSql = fs_1.default.readFileSync(path_1.default.join(__dirname, '02_functions.sql'), 'utf-8');
    ...
    const adminLoginId = 'OIMAN20250001';
    ...
    await (0, db_1.query)(`INSERT INTO employee_profiles (user_id, company_id, first_name, last_name, department_id, designation, location, date_of_joining, joining_serial_no)
     VALUES ($1, $2, 'Marc', 'Admin', $3, 'HR Manager & Admin', 'Gandhinagar', '2025-01-01', 1)`, [adminUserId, companyId, hrId]);
    ...
    for (const emp of createdEmployees) {
        for (let i = 30; i >= 0; i--) {
            ...
            // Randomize: 85% present, 10% absent, 5% on leave
